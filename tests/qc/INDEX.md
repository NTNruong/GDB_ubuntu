...
| [`c-embedded.md`](c-embedded.md) | C firmware-embedded (Register/MMIO, RTOS, DS+Math+Protocol) | TC-C-REG, TC-C-RTOS, TC-C-DS |
...
| `TC-C-DS-###`  | C — Data structures, fixed-point math, control, CRC, protocol parsers |
| `TC-CPP-###`   | C++ |
| `TC-PY-###`    | Python |

Số đánh 3 chữ số (001, 010, 099, 100...) reset theo prefix.
...
| C DS/Math/Protocol | `c-embedded.md` § DS | — | — |
| C++ STL | — | `cpp.md` § STL | — |
